   ...
   if (!$access_granted) {
      ...
      <div style="width:100%;margin-top:5px; border-spacing:0;clear:both;">
         <div style="margin-bottom:10px;margin-top:10px;">
            <label title="Shortcode"><?php echo $gb_shortcode; ?> : <span>(<a href="admin.php?page=gb_thumbnail_layout_shortcode" target="_blank"><?php echo $gb_add_shortcode; ?></a>)</span></label>
