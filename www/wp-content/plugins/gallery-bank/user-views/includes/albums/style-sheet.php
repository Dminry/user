   ...
   if (isset($album_type)) {
      ...
      switch (esc_attr($album_type)) {
         case "compact_album" :
            ...
            $compact_album_layout_cover_thumbnail_dimensions = isset($compact_album_layout_settings["compact_album_layout_cover_thumbnail_dimensions"]) ? explode(",", $compact_album_layout_settings["compact_album_layout_cover_thumbnail_dimensions"]) : "250,200";
            $compact_album_layout_cover_background_color_transparency = isset($compact_album_layout_settings["compact_album_layout_cover_background_color_transparency"]) ? explode(",", $compact_album_layout_settings["compact_album_layout_cover_background_color_transparency"]) : array("#ebe8eb", "50");
            ...
            $compact_album_layout_cover_border_style = isset($compact_album_layout_settings["compact_album_layout_cover_border_style"]) ? explode(",", $compact_album_layout_settings["compact_album_layout_cover_border_style"]) : array("0", "none", "#000000");
            ...
            $compact_album_layout_cover_shadow = isset($compact_album_layout_settings["compact_album_layout_cover_shadow"]) ? explode(",", $compact_album_layout_settings["compact_album_layout_cover_shadow"]) : array(0, 0, 0, 0);
            ...
            $compact_album_layout_cover_padding = isset($compact_album_layout_settings["compact_album_layout_cover_padding"]) ? explode(",", $compact_album_layout_settings["compact_album_layout_cover_padding"]) : array(0, 0, 0, 0);
