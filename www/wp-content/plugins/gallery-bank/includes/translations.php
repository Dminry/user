...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      ...
      if (array_key_exists("$locale", $wp_langs)) {
         ...
         $gb_message_translate_help = __("If you would like to translate in $language & help the wordpress community, please fill in the form", "gallery-bank");
         $gb_message_translate_here = __("here.", "gallery-bank");
      } else {
         $gb_message_translate_help = "";
         $gb_message_translate_here = "";
      }

      $gb_upgrade = __("Upgrade", "gallery-bank");

      // footer 
      $gb_translation_request = __("Translation Request", "gallery-bank");
      $gb_feature_requests_your_name = __("Your Name", "gallery-bank");
      $gb_feature_requests_your_name_tooltip = __("In this field, you would need to provide your Name which will be sent along with your Feature Request", "gallery-bank");
      $gb_feature_requests_your_name_placeholder = __("Please provide your Name", "gallery-bank");
      $gb_popup_your_name_tooltip = __("In this field, you would need to provide your Name which will be sent along with your request", "gallery-bank");
      $gb_feature_requests_your_email_placeholder = __("Please provide your Email Address", "gallery-bank");
      $gb_feature_requests_your_email = __("Your Email", "gallery-bank");
      $gb_popup_your_email_tooltip = __("In this field, you would need to provide your valid Email which will be sent along with your request", "gallery-bank");
      $gb_language_interested_to_translate = __("Language Interested to Translate", "gallery-bank");
      $gb_language_interested_to_translate_tooltip = __("Please enter the language you want to translate.", "gallery-bank");
      $gb_language_interested_to_translate_placeholder = __("Please enter the language", "gallery-bank");
      $gb_popup_query = __("Query", "gallery-bank");
      $gb_popup_query_tooltip = __("Please enter your query.", "gallery-bank");
      $gb_popup_query_placeholder = __("Please enter the query.", "gallery-bank");
      $gb_manage_backups_close = __("Close", "gallery-bank");
      $gb_feature_request_message = __("Your request Email has been sent Successfully", "gallery-bank");
      ...
      $gb_choose_type_message = __("Please choose atleast Source Type to generate shortcode!", "gallery-bank");
      $gb_choose_album_message = __("Please choose atleast one Album to generate shortcode!", "gallery-bank");
      $gb_choose_album_title = __("Choose Album", "gallery-bank");
      $gb_choose_type = __("Source Type", "gallery-bank");
      $gb_choose_type_placeholder = __("Choose Source Type", "gallery-bank");
      ...
      $gb_add_gallery_local_system = __("Local System", "gallery-bank");
      $gb_add_gallery_wp_media_manager = __("WP Media Manager", "gallery-bank");
      ...
      $gb_update_album_message = __("Album have been updated Successfully", "gallery-bank");
      $gb_update_album_title = __("Update Album", "gallery-bank");
      $gb_manage_albums_no_gallery_found = __("No Album Found", "gallery-bank");
      $gb_selected_albums_deleted = __("Selected Albums have been deleted Successfully", "gallery-bank");
      $gb_duplicate_albums = __("Selected Albums have been duplicated Successfully", "gallery-bank");
      $gb_confirm_delete_all_albums = __("Are you sure you want to delete all Albums ?", "gallery-bank");
      $gb_all_albums_deleted = __("All Albums have been deleted Successfully", "gallery-bank");
      $gb_album_delete_data = __("Album has been deleted Successfully", "gallery-bank");
      $gb_confirm_duplicate_album_message = __("Are you sure you want to duplicate these Albums ?", "gallery-bank");
      ...
      $gb_sort_albums_message = __("Please choose Album for Sorting", "gallery-bank");
      $gb_sort_albums_data = __("Albums has been sorted Successfully", "gallery-bank");
      $gb_untitled_album = __("Untitled Album", "gallery-bank");
      ...
      $gb_role_and_capability = __("Roles and Capabilities have been saved Successfully", "gallery-bank");

      //Feature Requests
      $gb_feature_requests_thank_you = __("Thank You!", "gallery-bank");
      $gb_feature_requests_fill_form = __("Kindly fill in the below form, if you would like to suggest some features which are not in the Plugin", "gallery-bank");
      $gb_feature_requests_any_suggestion = __("If you also have any suggestion/complaint, you can use the same form below", "gallery-bank");
      $gb_feature_requests_write_us_on = __("You can also write us on", "gallery-bank");
      $gb_feature_requests_name_title = __("Your Name", "gallery-bank");
      $gb_feature_requests_name_tooltip = __("In this field, you would need to provide your Name which will be sent along with your Feature Request", "gallery-bank");
      $gb_feature_requests_name_placeholder = __("Please provide your Name", "gallery-bank");
      $gb_feature_requests_email_title = __("Your Email", "gallery-bank");
      $gb_feature_requests_email_tooltip = __("In this field, you would need to provide your valid Email Address which will be sent along with your Feature Request", "gallery-bank");
      $gb_feature_requests_email_placeholder = __("Please provide your Email Address", "gallery-bank");
      $gb_feature_requests_tooltip = __("In this field, you would need to provide a feature which you would like to request to be added to this Plugin", "gallery-bank");
