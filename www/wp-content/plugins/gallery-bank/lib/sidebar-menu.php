...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      ...
      /*
        Function Name: gb_feature_requests
        Parameter: No
        Description: This function is used for feature-requests menu.
        Created On: 01-06-2017 09:00
        Created By: Tech Banker Team
       */
      function gb_feature_requests() {
         global $wpdb;
         $user_role_permission = get_users_capabilities_gallery_bank();
         if (file_exists(GALLERY_BANK_PLUGIN_DIR_PATH . "includes/translations.php")) {
            include GALLERY_BANK_PLUGIN_DIR_PATH . "includes/translations.php";
         ...
         if (file_exists(GALLERY_BANK_PLUGIN_DIR_PATH . "views/feature-requests/feature-requests.php")) {
            include_once GALLERY_BANK_PLUGIN_DIR_PATH . "views/feature-requests/feature-requests.php";
         }
         if (file_exists(GALLERY_BANK_PLUGIN_DIR_PATH . "includes/footer.php")) {
            include_once GALLERY_BANK_PLUGIN_DIR_PATH . "includes/footer.php";
         }
      ...
      function gb_upgrade() {
         ...
         if (file_exists(GALLERY_BANK_PLUGIN_DIR_PATH . "views/premium-editions/premium-editions.php")) {
            include_once GALLERY_BANK_PLUGIN_DIR_PATH . "views/premium-editions/premium-editions.php";
         }
         if (file_exists(GALLERY_BANK_PLUGIN_DIR_PATH . "includes/footer.php")) {
            include_once GALLERY_BANK_PLUGIN_DIR_PATH . "includes/footer.php";
         }
