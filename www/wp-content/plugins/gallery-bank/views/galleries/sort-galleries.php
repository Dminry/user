                                          ...
                                          <div class="thumbnail-csb">
                                             <div class="centered-csb">
                                                ...
                                                if ($image["file_type"] == "image") {
                                                   ?>
                                                   <img src="<?php echo GALLERY_BANK_THUMBS_CROPPED_URL . esc_attr($image["image_name"]); ?>" id="ux_txt_img_<?php echo intval($image["id"]); ?>" name="ux_txt_img_<?php echo intval($image["id"]); ?>" img_name="<?php echo esc_attr($image["image_name"]); ?>">
                                                   <?php
                                                }
                                                ?>
                                             </div>
