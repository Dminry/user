                     ...
                     <div class="form-body">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select id="ux_ddl_choose_type" name="ux_ddl_choose_type" class="form-control" onchange="shortcode_source_type_control_gallery_bank('ux_ddl_choose_type', 'ux_div_gallery', 'ux_div_album', 'ux_div_album_control'); premium_edition_notification_gallery_bank();">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $gb_slideshow_layout_shortcode_slideshow_width ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gb_slideshow_layout_shortcode_slideshow_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo " (" . $gb_premium_edition . " )"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <input type="text" class="form-control input-inline" name="ux_txt_slideshow_width" id="ux_txt_slideshow_width" placeholder="<?php echo $gb_width_layout_placeholder; ?>" onblur="set_thumbnail_dimension_in_shortcode(this,<?php echo $image_dimensions[0] ?>, '<?php echo $gb_shortcode_slideshow_width_exceed_msg; ?>'); premium_edition_notification_gallery_bank();" maxlength="4" onkeypress="digits_with_dot_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" value="800">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="form-group">
                           <label class="control-label">
                              <?php echo $gb_slideshow_layout_slideshow_flimstrips_title; ?> :
                              <i class="icon-custom-question tooltips" data-original-title="<?php echo $gb_slideshow_layout_slideshow_flimstrips_tooltip; ?>" data-placement="right"></i>
                              <span class="required" aria-required="true">* <?php echo " (" . $gb_premium_edition . " )"; ?></span>
                           </label>
                           <select name="ux_ddl_filmstrips" id="ux_ddl_filmstrips" class="form-control" onchange="premium_edition_notification_gallery_bank();">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $gb_slideshow_layout_control_button_title; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gb_slideshow_layout_control_button_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo " (" . $gb_premium_edition . " )"; ?></span>
                                 </label>
                                 <div class="input-icon right">
                                    <select name="ux_ddl_control_button" id="ux_ddl_control_button" class="form-control" onchange="premium_edition_notification_gallery_bank();">
                                       <option value="show"><?php echo $gb_show; ?></option>
                                       <option value="hide"><?php echo $gb_hide; ?></option>
                                    </select>
                                 </div>
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label class="control-label">
                                    <?php echo $gb_autoplay_title; ?> :
                                    <i class="icon-custom-question tooltips" data-original-title="<?php echo $gb_autoplay_tooltip; ?>" data-placement="right"></i>
                                    <span class="required" aria-required="true">* <?php echo " (" . $gb_premium_edition . " )"; ?></span>
                                 </label>
                                 <select id="ux_ddl_autoplay" name="ux_ddl_autoplay" class="form-control" onchange="premium_edition_notification_gallery_bank();">
                                    <option value="yes" selected><?php echo $gb_yes; ?></option>
                        ...
                        <div id="ux_div_time_interval">
                           <div class="form-group">
                              <label class="control-label">
                                 <?php echo $gb_time_interval_title; ?> :
                                 <i class="icon-custom-question tooltips" data-original-title="<?php echo $gb_time_interval_tooltip; ?>" data-placement="right"></i>
                                 <span class="required" aria-required="true">* <?php echo " (" . $gb_premium_edition . " )"; ?></span>
                              </label>
                              <input type="text" class="form-control" name="ux_txt_time_interval" id="ux_txt_time_interval" value="5" maxlength="3" onkeypress="only_digits_gallery_bank(event);" onblur="default_value_gallery_bank('#ux_txt_time_interval', 5); premium_edition_notification_gallery_bank();" onfocus="paste_prevent_gallery_bank(this.id);" placeholder="<?php echo $gb_time_interval_placeholder; ?>">
                           </div>
                        </div>
