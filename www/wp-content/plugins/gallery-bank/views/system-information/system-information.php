 ...
 *
 * @author 	Tech Banker
 * @package 	gallery-bank/views/system-information
 * @version	4.0.0
 */
if (!defined("ABSPATH")) {
   exit;
...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      return;
   } else if (system_information_gallery_bank == "1") {
      ?>
      <div class="page-bar">
                           ...
                           <table class="table table-striped table-bordered table-hover" >
                              ...
                              <tbody>
                                 ...
                                 $params = array
                                     ...
                                     "sslverify" => false,
                                     "timeout" => 60,
                                     "user-agent" => "gallery_bank",
                                     "body" => $request
                                 );
                                 $response = wp_remote_post("https://paypal.com/cgi-bin/webscr", $params);
                                 ?>
                                 <tr>
                                    <td>
                                       <strong>
