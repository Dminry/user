...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      ...
      $compact_album_layout_gallery_description_padding = isset($compact_album_layout_data["compact_album_layout_gallery_description_padding"]) ? explode(",", esc_attr($compact_album_layout_data["compact_album_layout_gallery_description_padding"])) : array(5, 10, 10, 10);
                           ...
                           <div class="tab-content">
                              <div class="tab-pane active" id="thumbnails">
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_background_color_transperancy[]" id="ux_txt_background_color" placeholder="<?php echo $gb_background_color; ?>" onfocus="color_picker_gallery_bank(this, this.value)"  value="<?php echo esc_attr($compact_album_layout_cover_background_color_transparency[0]); ?>">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_background_color_transperancy[]" id="ux_txt_background_transperancy" maxlength="3" placeholder="<?php echo $gb_background_transparency; ?>"  onblur="default_value_gallery_bank('#ux_txt_background_transperancy', 50);" onkeypress="only_digits_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" onchange="check_opacity_gallery_bank(this);" value="<?php echo intval($compact_album_layout_cover_background_color_transparency[1]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="form-group custom-margin-top">
                                    ...
                                    <div class="input-icon right">
                                       <input type="text" class="form-control" name="ux_txt_opacity" id="ux_txt_opacity" placeholder="<?php echo $gb_opacity_placeholder; ?>" onblur="default_value_gallery_bank('#ux_txt_opacity', 100);" maxlength="3" onkeypress="only_digits_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" onchange="check_opacity_gallery_bank(this);" value="<?php echo isset($compact_album_layout_data["compact_album_layout_cover_thumbnail_opacity"]) ? intval($compact_album_layout_data["compact_album_layout_cover_thumbnail_opacity"]) : 100; ?>">
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             ...
                                             <input type="text" class="form-control input-normal input-inline" name="ux_txt_border_style[]" id="ux_txt_border_style_color" onblur="default_value_gallery_bank('#ux_txt_border_style_color', '#000000')" onfocus="color_picker_gallery_bank(this, this.value)" placeholder="<?php echo $gb_color_placeholder; ?>" value="<?php echo esc_attr($compact_album_layout_cover_border_style[2]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_border_radius" id="ux_txt_border_radius" placeholder="<?php echo $gb_border_radius_placeholder; ?>" maxlength="3" onkeypress="only_digits_gallery_bank(event);" onblur="default_value_gallery_bank('#ux_txt_border_radius', 0)" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo isset($compact_album_layout_data["compact_album_layout_cover_border_radius"]) ? intval($compact_album_layout_data["compact_album_layout_cover_border_radius"]) : 0; ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_transition_time" id="ux_txt_transition_time" placeholder="<?php echo $gb_transition_time_placeholder; ?>" onblur="default_value_gallery_bank('#ux_txt_transition_time', 1)" maxlength="1" onkeypress="digits_with_dot_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo isset($compact_album_layout_data["compact_album_layout_cover_transition_time"]) ? intval($compact_album_layout_data["compact_album_layout_cover_transition_time"]) : 1; ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_album_title_font_style[]" id="ux_txt_album_title_font_size" placeholder="<?php echo $gb_font_size_placeholder; ?>" onblur="default_value_gallery_bank('#ux_txt_album_title_font_size', 20);" maxlength="3" onkeypress="only_digits_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo intval($compact_album_layout_title_font_style[0]); ?>">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_album_title_font_style[]" id="ux_txt_album_title_style_color"  onblur="default_value_gallery_bank('#ux_txt_album_title_style_color', '#000000');" onfocus="color_picker_gallery_bank(this, this.value)" placeholder="<?php echo $gb_color_placeholder; ?>" value="<?php echo esc_attr($compact_album_layout_title_font_style[1]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select name="ux_ddl_album_title_font_family" id="ux_ddl_album_title_font_family" class="form-control">
                                       ...
                                       if (file_exists(GALLERY_BANK_PLUGIN_DIR_PATH . "includes/web-fonts.php")) {
                                          $web_font_list = include GALLERY_BANK_PLUGIN_DIR_PATH . "includes/web-fonts.php";
                                       }
                                       ?>
                                    </select>
                                 </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="ux_txt_compact_album_button_text" name="ux_txt_compact_album_button_text" placeholder="<?php echo $gb_button_text_placeholder; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_text', 'Back To Album');"   value="<?php echo isset($compact_album_layout_data["compact_album_layout_button_text"]) ? esc_attr($compact_album_layout_data["compact_album_layout_button_text"]) : 'Back To Album'; ?>">
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="ux_txt_compact_album_button_color" name="ux_txt_compact_album_button_color" placeholder="<?php echo $gb_album_button_color_placeholder; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_color', '#a4cd39');"   onfocus="color_picker_gallery_bank(this, this.value); paste_prevent_gallery_bank(this.id);" value="<?php echo isset($compact_album_layout_data["compact_album_layout_button_color"]) ? esc_attr($compact_album_layout_data["compact_album_layout_button_color"]) : '#a4cd39'; ?>">
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="ux_txt_compact_album_button_hover_color" name="ux_txt_compact_album_button_hover_color" placeholder="<?php echo $gb_album_button_hover_color_placeholder; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_hover_color', '#a4cd39');"   onfocus="color_picker_gallery_bank(this, this.value); paste_prevent_gallery_bank(this.id);" value="<?php echo isset($compact_album_layout_data["compact_album_layout_button_hover_color"]) ? esc_attr($compact_album_layout_data["compact_album_layout_button_hover_color"]) : '#a4cd39'; ?>">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control input-width-25 input-inline" name="ux_txt_compact_album_button_border_style[]" id="ux_txt_compact_album_button_border_size" placeholder="<?php echo $gb_width_placeholder; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_border_size', 0);" maxlength="3" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo intval($compact_album_layout_button_border_style[0]); ?>">
                                             ...
                                             <input type="text" class="form-control input-normal input-inline" name="ux_txt_compact_album_button_border_style[]" id="ux_txt_compact_album_button_border_color" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_border_color', '#a4cd39');" onfocus="color_picker_gallery_bank(this, this.value)" placeholder="<?php echo $gb_color_placeholder; ?>" value="<?php echo esc_attr($compact_album_layout_button_border_style[2]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_compact_album_button_border_hover" id="ux_txt_compact_album_button_border_hover" onfocus="color_picker_gallery_bank(this, this.value)" placeholder="<?php echo $gb_button_border_hover_placeholder; ?>"  onblur="default_value_gallery_bank('#ux_txt_compact_album_button_border_hover', '#a4cd39');" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo isset($compact_album_layout_data["compact_album_layout_button_border_hover_color"]) ? esc_attr($compact_album_layout_data["compact_album_layout_button_border_hover_color"]) : '#a4cd39'; ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control" name="ux_txt_compact_album_button_border_radius" id="ux_txt_compact_album_button_border_radius" placeholder="<?php echo $gb_border_radius_placeholder; ?>" maxlength="3"  onblur="default_value_gallery_bank('#ux_txt_compact_album_button_border_radius', 4)" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo isset($compact_album_layout_data["compact_album_layout_button_border_radius"]) ? intval($compact_album_layout_data["compact_album_layout_button_border_radius"]) : 4; ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_compact_album_button_font_style[]" id="ux_txt_compact_album_button_font_size" placeholder="<?php echo $gb_font_size_placeholder; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_font_size', 14);" maxlength="3" onkeypress="only_digits_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo intval($compact_album_layout_button_font_style[0]); ?>">
                                             <input type="text" class="form-control custom-input-medium input-inline" name="ux_txt_compact_album_button_font_style[]" id="ux_txt_compact_album_button_font_color" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_font_color', '#ffffff');" onfocus="color_picker_gallery_bank(this, this.value)" placeholder="<?php echo $gb_color_placeholder; ?>" value="<?php echo esc_attr($compact_album_layout_button_font_style[1]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="ux_txt_compact_album_button_font_hover_color" name="ux_txt_compact_album_button_font_hover_color" onfocus="color_picker_gallery_bank(this, this.value)" placeholder="<?php echo $gb_button_font_hover_placeholder; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_font_hover_color', '#ffffff');"  onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo isset($compact_album_layout_data["compact_album_layout_button_font_hover_color"]) ? esc_attr($compact_album_layout_data["compact_album_layout_button_font_hover_color"]) : '#ffffff'; ?>">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_compact_album_button_margin_text[]" id="ux_txt_compact_album_button_margin_top" placeholder="<?php echo $gb_top; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_margin_top', 10);" maxlength="3" onkeypress="only_digits_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo intval($compact_album_layout_button_margin[0]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_compact_album_button_margin_text[]" id="ux_txt_compact_album_button_margin_right" placeholder="<?php echo $gb_right; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_margin_right', 0);" maxlength="3" onkeypress="only_digits_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo intval($compact_album_layout_button_margin[1]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_compact_album_button_margin_text[]" id="ux_txt_compact_album_button_margin_bottom" placeholder="<?php echo $gb_bottom; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_margin_bottom', 0);" maxlength="3" onkeypress="only_digits_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo intval($compact_album_layout_button_margin[2]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_compact_album_button_margin_text[]" id="ux_txt_compact_album_button_margin_left" placeholder="<?php echo $gb_left; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_margin_left', 0);" maxlength="3" onkeypress="only_digits_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo intval($compact_album_layout_button_margin[3]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_compact_album_button_padding_text[]" id="ux_txt_compact_album_button_padding_top" placeholder="<?php echo $gb_top; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_padding_top', 8);" maxlength="3" onkeypress="only_digits_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo intval($compact_album_layout_button_padding[0]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_compact_album_button_padding_text[]" id="ux_txt_compact_album_button_padding_right" placeholder="<?php echo $gb_right; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_padding_right', 12);" maxlength="3" onkeypress="only_digits_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo intval($compact_album_layout_button_padding[1]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_compact_album_button_padding_text[]" id="ux_txt_compact_album_button_padding_bottom" placeholder="<?php echo $gb_bottom; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_padding_bottom', 8);" maxlength="3" onkeypress="only_digits_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo intval($compact_album_layout_button_padding[2]); ?>">
                                             <input type="text" class="form-control custom-input-xsmall input-inline" name="ux_txt_compact_album_button_padding_text[]" id="ux_txt_compact_album_button_padding_left" placeholder="<?php echo $gb_left; ?>" onblur="default_value_gallery_bank('#ux_txt_compact_album_button_padding_left', 12);" maxlength="3" onkeypress="only_digits_gallery_bank(event);" onfocus="paste_prevent_gallery_bank(this.id);" value="<?php echo intval($compact_album_layout_button_padding[3]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
