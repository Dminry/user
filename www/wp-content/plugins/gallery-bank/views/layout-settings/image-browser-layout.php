                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             <input type="text" class="form-control valid" name="ux_txt_background_color_image_browser" id="ux_txt_background_color_image_browser" placeholder="<?php echo $gb_background_color_placeholder; ?>" onblur="default_value_gallery_bank('#ux_txt_background_color_image_browser', '#ebe8eb');" onfocus="color_picker_gallery_bank(this, this.value)" value="<?php echo isset($image_browser_layout_data["image_browser_layout_general_image_browser_background_color"]) ? esc_attr($image_browser_layout_data["image_browser_layout_general_image_browser_background_color"]) : "#ebe8eb"; ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <div class="input-icon right">
                                             ...
                                             <input type="text" class="form-control input-normal input-inline" name="ux_txt_border_style_image[]" id="ux_txt_border_style_color_image" onblur="default_value_gallery_bank('#ux_txt_border_style_color_image', '#00000')" onfocus="color_picker_gallery_bank(this, this.value)" placeholder="<?php echo $gb_color_placeholder; ?>" value="<?php echo esc_attr($image_browser_layout_general_border_style[2]); ?>">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
