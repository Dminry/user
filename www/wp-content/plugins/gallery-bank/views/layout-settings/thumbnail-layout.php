...
if (!is_user_logged_in()) {
   ...
   if (!$access_granted) {
      ...
      $thumbnail_layout_thumbnail_position = isset($manage_thumbnail_data["thumbnail_layout_thumbnail_position"]) ? explode(",", esc_attr($manage_thumbnail_data["thumbnail_layout_thumbnail_position"])) : array(200, 150);
      ?>
      <div class="page-bar">
